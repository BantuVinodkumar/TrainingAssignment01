...
namespace CaseStudy
{
    class AppEngine
    {
        ...
        static SqlConnection getConnection()
        {
            ...
            con = new SqlConnection(@"Data Source=ADMW46ZLPC1567\SQLEXPRESS;Initial Catalog=StudentManagementSystem;Integrated Security=True;MultipleActiveResultSets=True");
            con.Open();
            return con;
        }
